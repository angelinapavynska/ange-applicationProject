        ...
        <form action="updateBooking.php" method="post">
            <table style="width: 100%; margin-bottom: 10px" class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>Email</td>
                    <td><input type="email" style="width: 100%" name="emailUpdate" required></td>
                </tr>
                <tr>
                    <td>Guests(>18)</td>
                    <td><input type="text" style="width: 100%" name="guestsUpdate" required></td>
                    <td>Children(<18) </td> <td><input type="text" style="width: 100%" name="childrenUpdate" required></td>
                </tr>
                <tr>
                    <td>Arrival Date</td>
            ...
            function update()
            {
                ...
                $sql = "UPDATE Clients
       SET  Name = '$first_name', LastName = '$last_name', Email = '$email', Guests = '$guests', ArrivalDate = '$arrivalDate', DepartureDate = '$departureDate', Children = '$children'
       WHERE id='$id'";
                ...
                $sql = "DELETE FROM Booking WHERE Client_id = '$id' ";
